...
public class NewCharacterController : NetworkTransform
{
  ...
  private void CacheController()
  {
    if (Controller == null)
    {
      ...
      Assert.Check(Controller != null, $"An object with {nameof(NewCharacterController)} must also have a {nameof(CharacterController)} component.");
    }
  }
